...
import com.mediFirst.adapter.CustomMedicalProblemsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                fillProblemsImages();
                fillProblemsText();
                com.mediFirst.adapter.CustomMedicalProblemsAdapter customMedicalProblemsAdapter = new CustomMedicalProblemsAdapter(MedicalProblems.this, problemsImages, problemsText);
