...
import com.mediFirst.Common.Common;
import com.mediFirst.Medical.MedicalProblems;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        medicines.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent k = new Intent(HomeActivity.this, MedicalProblems.class);
                startActivity(k);
            }
        });

        steps_count = findViewById(R.id.steps_count);
        steps_count.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Toast.makeText(HomeActivity.this, "Exercise Here..", Toast.LENGTH_SHORT).show();
                Intent k = new Intent(HomeActivity.this, steps_counter.class);
                startActivity(k);
            }
        });
        ...
        map_activity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(HomeActivity.this, "Map Here..", Toast.LENGTH_SHORT).show();
//                Intent k = new Intent(HomeActivity.this, MedicalProblems.class);
//                startActivity(k);
            }
        });
